...
Route::group(['middleware' => ['CheckAdmin']], function () {
   ...
   /* POS Section */
   // Route::get('/create-old-invoice', [PosController::class, 'create']);
   // Route::get('/create-invoice', [PosController::class, 'createInvoice']);
   // Route::post('/search-category-wise-items', [PosController::class, 'searchCategoryWiseItems']);
   // Route::get('/search-specific-items', [PosController::class, 'searchSpecificItems']);
   // Route::post('/save-pos-invoice', [PosController::class, 'saveInvoice']);
