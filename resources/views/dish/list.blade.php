...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            <!-- start page title -->
            <div align="right">
                <a href="{{url('create-dish')}}" class="btn btn-success">Add Dish</a>
            </div><br>
            <div class="row">
                        ...
                        <div class="card card-box">
                            <div class="contact-card">
                                ...
                                <div class="member-info">
                                    ...
                                    <div class="contact-action pull-right">
                                        <a href="{{route('dish.edit',[$dish->id])}}" class="btn btn-success btn-sm"><i
                                                    class="fa fa-edit"></i></a>
                                        <a href="http://restulator.binarycastle.net/view-dish/1" class="btn btn-info btn-sm"><i
                                                    class="fa fa-eye"></i></a>
                                        <a href="#" onclick="delete_confirm2(`dishDelete`,'{{$dish->id}}')"
                                           class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                    </div>
                                    <h4 class="header-title"><b>{{ucwords($dish->name)}}</b></h4>
