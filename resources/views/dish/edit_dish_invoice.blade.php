...
@section('title', 'Edit Dish Invoice')
...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form action="{{URL('/updateDishOrder')}}" method="post">
                        ...
                        <div class="row col-md-12">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="text" name="invoice_no" value="{{$invoice_master->InvoiceNo}}" id="invoice_no" readonly class="form-control" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="date" name="invoice_date" value="{{$invoice_master->Date}}" id="invoice_date" class="form-control" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <select name="dish_table_id" id="dish_table_id" class="form-select form-control-sm select2">
                                        ...
                                        @foreach ($dish_tables as $dish_table)
                                            <option value="{{$dish_table->id}}" {{$dish_table_id == $dish_table->id ? 'selected' : ''}}>{{$dish_table->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            $no = $key + 1;
                                            $dish = App\Models\Dish::where('id',$value1->dish_id)->first();
                                            $type = App\Models\DishType::where('id',$value1->dish_type_id)->first();
                                            $amount = $type->price * $value1->quantity;
                                        ?>
                                        ...
                                        <tr class="p-3">
                                            ...
                                            <td>
                                                <select name="dish_id[]" id="dish_id_{{$no}}" class="dish form-select form-control-sm select2" onchange="getDishTypes(this.value,{{$no}});" style="width: 300px !important;">
                                                    <option value="">Select Dish</option>
                                                    @foreach ($dishes as $key => $value)
                                                        <option value="{{$key}}" {{($key == $value1->dish_id) ? 'selected' : '' }}>{{$value}}</option>
                                                    @endforeach
                                                </select>
                                            </td>
                                            <td>
                                                ...
                                                <select name="ItemID0[]" id="ItemID0_{{$no}}" class="item form-select form-control-sm changesNoo select2" onchange="km(this.value,{{$no}});" style="width: 300px !important;">
                                                    ...
                                                    @foreach ($dish->dish_types as $dish_type)
                                                    <option value="{{$dish_type->id}}" {{($dish_type->id== $value1->dish_type_id) ? 'selected=selected':'' }}>{{$dish_type->type}}</option>
                                                    @endforeach
                                                </select>
                                                <input type="hidden" name="ItemID[]" id="ItemID_{{$no}}" value="{{$value1->dish_type_id}}">
                                            </td>


                                            <td>
                                                <input type="number" name="Qty[]" id="Qty_{{$no}}" class=" form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="{{$value1->quantity}}">
                                            </td>

                                            <td>
                                                <input type="number" name="Price[]" id="Price_{{$no}}" class=" form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="{{$type->price}}">
                                            </td>
                                            ...
                                            <td>
                                                <input type="number" name="ItemTotal[]" id="ItemTotal_{{$no}}" class=" form-control totalLinePrice " autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="{{$amount}}">
                                            </td>
                                        </tr>
                            ...
                            <div class="col-lg-6 col-12  ">
                                ...
                                <div class="form-group mt-1">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="subTotal" name="SubTotal" placeholder="Subtotal" onkeypress="return IsNumeric(event);" ondrop="return false;" value="{{$invoice_master->SubTotal}}" onpaste="return false;" readonly>
                                    </div>
                                </div>
                                <div class="form-group mt-1">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="DiscountAmount" class="form-control" id="discountAmount" onkeypress="return IsNumeric(event);" value="{{$invoice_master->DiscountAmount}}" ondrop="return false;" onpaste="return false;" value="0">
                                    </div>
                                </div>
                                <div class="form-group mt-1 d-none">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text bg-light">{{session::get('Currency')}}</span>
                                        <input type="number" name="Shipping" class="form-control" step="0.01" id="shipping" placeholder="Grand Total" onkeypress="return IsNumeric(event);" ondrop="return false;" value="{{$invoice_master->Shipping}}" onpaste="return false;" value="0">
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 col-12 ">
                                <!-- <input type="text" class="form-control" id="TotalTaxAmount" name="TaxTotal" placeholder="TaxTotal" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"> -->
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-light">{{session::get('Currency')}}</span>
                                            <input type="number" name="Total" class="form-control" step="0.01" id="totalafterdisc" readonly placeholder="Total" onkeypress="return IsNumeric(event);" value="{{$invoice_master->Total}}" ondrop="return false;" onpaste="return false;">
                                        </div>
                                    </div>
                                    <div class="form-group mt-1 d-none">
                                        <label>Tax: &nbsp;</label>
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-light">{{session::get('Currency')}}</span>
                                            <input type="number" name="Grandtotal" class="form-control" step="0.01" id="grandtotal" placeholder="Grand Total" readonly onkeypress="return IsNumeric(event);" value="{{$invoice_master->GrandTotal}}" ondrop="return false;" onpaste="return false;" value="0">
                                        </div>
                                    </div>
